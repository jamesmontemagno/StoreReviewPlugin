...
* Occasionally, some devices may not show the popup at all as (seen here)[https://github.com/jamesmontemagno/StoreReviewPlugin/pull/27#issuecomment-877410136]. One way to test whether your app is affected by it, is by downloading (this game that uses v3.1 of this nuget, target SDK version 30, target framework v11.0)[https://play.google.com/store/apps/details?id=com.tfp.numberbomb] and win the game once to see the popup. You can debug the error using adb locat, as you can (see here)[https://github.com/jamesmontemagno/StoreReviewPlugin/issues/26#issue-940942211]
